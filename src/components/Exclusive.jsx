    ...
    <div className="bg-[#5169f513] mt-2 lg:mt-20 mb-14 lg:mb-32 px-4 ">
      <div className="max-w-7xl mx-auto">
        <section className="grid grid-cols-1 lg:grid-cols-2  items-center gap-10 py-5">
          {/* Left Text */}
          <div>
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-16 text-[#691b1b]">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-stretch w-full">
            {/* Card 1 */}
            <div className="flex-1 flex flex-col bg-white border border-gray-200 p-6 md:p-8 rounded-lg shadow-sm w-full lg:relative lg:-top-16">
